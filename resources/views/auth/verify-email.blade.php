...
<div class="auth-card">
    ...
    @if (session('success'))
        <div class="auth-alert auth-alert-success" style="color: #155724; background-color: #d4edda; border-color: #c3e6cb; padding: .75rem 1.25rem; margin-bottom: 1rem; border: 1px solid transparent; border-radius: .25rem;">
            {{ session('success') }}
        </div>
    @endif

    <div class="button-group">
        <a href="{{ route('login') }}" class="auth-button" style="width: 100%; text-align: center; text-decoration: none; display: block; box-sizing: border-box;">
            Proceed to Login
        </a>
