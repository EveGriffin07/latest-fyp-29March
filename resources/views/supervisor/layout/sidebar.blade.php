@php
  ...
  elseif ($isSupervisor && (request()->is('supervisor/*') || request()->is('manager/interviews*') || request()->is('employee/team/*') || request()->is('employee/ot-claims-inbox*') || request()->is('employee/overtime_inbox*')) && !request()->routeIs('supervisor.profile')) $openSection = 'team';
@endphp
...
<aside class="sidebar">
  ...
  <div class="sidebar-group {{ $openSection === 'team' ? 'open' : '' }}">
    ...
    <ul class="submenu">
      ...
      <li><a href="{{ route('manager.interviews.index') }}" class="{{ request()->routeIs('manager.interviews.*') ? 'active' : '' }}">Upcoming Interviews</a></li>
      ...
      <li><a href="{{ route('employee.team.payroll_adjustments') }}" class="{{ request()->routeIs('employee.team.payroll_adjustments*') ? 'active' : '' }}">Team salary adjustments</a></li>
